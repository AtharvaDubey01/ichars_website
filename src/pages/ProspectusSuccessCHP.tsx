...
export const ProspectusSuccessCHP = () => {
    return (
            ...
            <Section className="pb-20 pt-4 md:pt-10">
                <div className="max-w-3xl mx-auto text-center mb-16">
                    ...
                    <Text size="lg" className="text-brand-secondary-text mb-4">
                        The <strong>Cognitive Hypnotic Psychotherapy (CHP)</strong> prospectus has been sent to your email. It should arrive within the next 5 minutes.
                    </Text>
                ...
                <div className="max-w-4xl mx-auto mb-16">
                    <div className="text-center mb-8">
                        ...
                        <Heading level={2} className="text-2xl md:text-3xl text-brand-structural-navy mb-4">
                            While you wait, understand the CHP framework
                        </Heading>
                        <Text size="lg" className="text-brand-secondary-text max-w-2xl mx-auto">
                            If you've ever felt stuck with a client despite trying different modalities, this short video explains why that happens—and how an integrative psychotherapy framework makes the difference.
                        </Text>
                    </div>
                    ...
                    <div className="bg-brand-structural-navy rounded-2xl overflow-hidden shadow-xl border border-brand-soft-neutral/30">
                        <div className="bg-[#1a2f40] px-6 py-4 border-b border-white/10 flex justify-between items-center">
                            <h2 className="text-white font-semibold">How CHP bridges the gap between therapy modalities</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-white p-8 rounded-2xl border border-brand-soft-neutral/50 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <Text size="sm" className="mb-6">
                                Unsure if you meet the eligibility criteria for the clinical levels of CHP? Book a free consultation call to clarify your path.
                            </Text>
                        ...
                        <div className="bg-white p-8 rounded-2xl border border-brand-soft-neutral/50 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <Text size="sm" className="mb-6">
                                The CHP Diploma is our most comprehensive journey. See how it connects with specific niches and internships within the ICHARS ecosystem.
                            </Text>
