...
export const ProspectusSuccessSchool = () => {
    return (
            ...
            <Section className="pb-20 pt-4 md:pt-10">
                <div className="max-w-3xl mx-auto text-center mb-16">
                    ...
                    <Text size="lg" className="text-brand-secondary-text mb-4">
                        The <strong>School Counselling Specialization</strong> prospectus has been sent to your email. It should arrive within the next 5 minutes.
                    </Text>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-white p-8 rounded-2xl border border-brand-soft-neutral/50 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <Text size="sm" className="mb-6">
                                Want to understand how this specialization fits into your career goals as an educator or counsellor? Book a discussion with us.
                            </Text>
                        ...
                        <div className="bg-white p-8 rounded-2xl border border-brand-soft-neutral/50 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <Text size="sm" className="mb-6">
                                Discover how our methodology supports systemic change in educational environments through the ICHARS ecosystem.
                            </Text>
