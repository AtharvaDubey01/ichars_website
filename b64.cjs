...
import { BookOpen, Brain, Microscope, Heart, Users, Network, Activity, Search, FileText, ArrowRight, Layers, Workflow, CheckCircle2 } from 'lucide-react';

const researchPapers = ${rawArray};
                                ...
                                <div className="space-y-4">
                                    {filteredPapers.map((paper, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="mt-4 sm:mt-0 shrink-10 self-start sm:self-center">
...
fs.writeFileSync('src/pages/Research.tsx', 'utf8');
console.log('Successly updated Research.tsx');
